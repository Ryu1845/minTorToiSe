# copied from https://github.com/cloneofsimo/minDiffusion/blob/master/superminddpm.py
"""
...
def blk(ic, oc):
    return nn.Sequential(nn.Conv2d(ic, oc, 7, padding=3), nn.BatchNorm2d(oc), nn.LeakyReLU())
